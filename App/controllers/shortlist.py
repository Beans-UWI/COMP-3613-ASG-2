...
from App.controllers import get_employer_by_username, get_internships_by_employer_id, get_student_by_username
from App.controllers.state import get_session_state
from App.controllers.staff import get_current_staff_id
from App.database import db

def create_shortlist(student_id, internship_id):
